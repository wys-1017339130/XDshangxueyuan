 ...
 * Licensed under the MIT license */
  function (t, e, n, i) {
    ...
    var pt, ht = ["", "webkit", "Moz", "MS", "ms", "o"], dt = e.createElement("div"), ft = "function", mt = Math.round,
      vt = Math.abs, gt = Date.now;
    ...
    var wt = s(function (t, e, n) {
      ...
      Ct = T(t, "PointerEvent") !== i, bt = xt && kt.test(navigator.userAgent), Mt = "touch", _t = "pen", Et = "mouse",
      Dt = "kinect", Ot = 25, Pt = 1, At = 2, It = 4, Ht = 8, St = 1, Yt = 2, Vt = 4, Nt = 8, Ft = 16, qt = Yt | Vt,
      zt = Nt | Ft, Lt = qt | zt, Rt = ["x", "y"], jt = ["clientX", "clientY"];
    C.prototype = {
      handler: function () {
      }, init: function () {
    ...
    var Xt = {mousedown: Pt, mousemove: At, mouseup: It}, $t = "mousedown", Wt = "mousemove mouseup";
    c(N, C, {
      handler: function (t) {
        var e = Xt[t.type];
    ...
    var ae = T(dt.style, "touchAction"), re = ae !== i, oe = "compute", se = "auto", ce = "manipulation", le = "none",
      ue = "pan-x", pe = "pan-y", he = B();
    K.prototype = {
      set: function (t) {
    ...
    G.prototype = {
      ...
      defaults: {event: "pan", threshold: 10, pointers: 1, direction: Lt}, getTouchAction: function () {
  ...
  t.modal = function (n, i) {
    ...
    return "object" == typeof n ? r = n : ("function" == typeof i && (a = arguments[1], i = void 0), r = {
      ...
      title: i,
      onOK: a
    }), t.modal({text: r.text, title: r.title, buttons: [{text: e.buttonOK, className: "primary", onClick: r.onOK}]})
  ...
  "use strict";
  var e = {}, n = navigator.userAgent, i = n.match(/(Android);?[\s\/]+([\d.]+)?/), a = n.match(/(iPad).*OS\s([\d_]+)/),
    r = n.match(/(iPod)(.*OS\s([\d_]+))?/), o = !a && n.match(/(iPhone\sOS)\s([\d_]+)/);
        ...
        h.setValue = function (e, n, a) {
          ...
          if ((a || "undefined" == typeof a) && (h.value = o.attr("data-picker-value"), h.displayValue = h.displayValues ? h.displayValues[e] : h.value, r !== e && (h.onChange && h.onChange(c, h.value, h.displayValue), c.updateValue())), c.params.rotateEffect) {
            ...
            h.items.each(function () {
              var e = t(this), i = e.index() * f, a = g - n, r = i - a, o = r / f, s = Math.ceil(h.height / f / 2) + 1,
                c = -18 * o;
  ...
  var e, n = !1, i = function (t, e) {
    ...
    return p.animating = !1, p.addValue = function (t) {
      ...
      0 === o && (o = 7);
      var s, c, l, u = [], h = 6, d = 7, f = "", m = 0 + (p.params.firstDay - 1), v = (new Date).setHours(0, 0, 0, 0),
      ...
      var n = parseInt(p.months.eq(p.months.length - 1).attr("data-month"), 10),
        i = parseInt(p.months.eq(p.months.length - 1).attr("data-year"), 10), a = new Date(i, n), r = a.getTime(),
        o = !p.animating;
  ...
  "use strict";
  var e = [], n = "swipeout-touching", i = function (n) {
    this.container = t(n), this.mover = this.container.find(">.weui-cell__bd"), this.limit = this.container.find(">.weui-cell__ft").width() || 68, this.attachEvents(), e.push(this)
  };
  i.prototype.touchStart = function (e) {
    ...
    a && a.length && (this.startX = parseInt(a[4])), this.diffX = this.diffY = 0, this._closeOthers()
    ...
    if (!this.start)return !0;
    this.start = !1;
    var t = this.diffX + this.startX, e = new Date - this.startTime;
  ...
  t.fn.swipeout = function (e) {
    return this.each(function () {
      var n = t(this), i = n.data("swipeout") || a(this);
