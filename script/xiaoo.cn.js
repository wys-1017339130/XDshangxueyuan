(function(global){'use strict';global.hp={};})(this||[eval][0]('this'));(function(global){'use strict';if(typeof global.setTimeout!=="undefined"){return;}
    ...
    global.hp.defineProperties=defineProperties;global.hp.createObject=createObject;global.hp.generic=generic;global.hp.toBinaryString=toBinaryString;global.hp.toUint8Array=toUint8Array;global.hp.toArray=toArray;global.hp.parseuri=parseuri;})(this||[eval][0]('this'));(function(global,undefined){'use strict';if(!Function.prototype.bind){Function.prototype.bind=function(oThis){if(typeof this!=='function'){throw new TypeError('Function.prototype.bind - what is trying to be bound is not callable');}
    ...
    var generic=global.hp.generic;function genericMethods(obj,properties){var proto=obj.prototype;for(var i=0,len=properties.length;i<len;i++){var property=properties[i];var method=proto[property];if(typeof method==='function'&&typeof obj[property]==='undefined'){obj[property]=generic(method);}}}
    ...
    TimeoutError.prototype=global.hp.createObject(Error.prototype);TimeoutError.prototype.constructor=TimeoutError;global.TimeoutError=TimeoutError;}})(this||[eval][0]('this'));(function(global,undefined){'use strict';if(global.setImmediate){return;}
    ...
    defineProperties(Future.prototype,{_value:{writable:true},_reason:{writable:true},_state:{value:PENDING,writable:true},resolve:{value:function(value){if(value===this){this.reject(new TypeError('Self resolution'));return;}
        ...
        return reduceRight(this,callback);}},indexOf:{value:function(searchElement,fromIndex){return indexOf(this,searchElement,fromIndex);}},lastIndexOf:{value:function(searchElement,fromIndex){return lastIndexOf(this,searchElement,fromIndex);}},includes:{value:function(searchElement,fromIndex){return includes(this,searchElement,fromIndex);}},find:{value:function(predicate,thisArg){return find(this,predicate,thisArg);}},findIndex:{value:function(predicate,thisArg){return findIndex(this,predicate,thisArg);}}});global.hp.Future=Future;function Completer(){var future=new Future();defineProperties(this,{future:{value:future},complete:{value:future.resolve},completeError:{value:future.reject},isCompleted:{get:function(){return(future._state!==PENDING);}}});}
    global.hp.Completer=Completer;global.hp.resolved=value;global.hp.rejected=error;global.hp.deferred=function(){var self=new Future();return createObject(null,{promise:{value:self},resolve:{value:self.resolve},reject:{value:self.reject}});};if(hasPromise){return;}
    global.Promise=function(executor){Future.call(this);executor(this.resolve,this.reject);};global.Promise.prototype=createObject(Future.prototype);global.Promise.prototype.constructor=Future;defineProperties(global.Promise,{all:{value:all},race:{value:race},resolve:{value:value},reject:{value:error}});})(this||[eval][0]('this'));(function(global){'use strict';var defineProperties=global.hp.defineProperties;var createObject=global.hp.createObject;function BinaryString(bs,needtest){if(!needtest||/^[\x00-\xff]*$/.test(bs)){defineProperties(this,{length:{value:bs.length},toString:{value:function(){return bs;}},valueOf:{value:function(){return bs;},writable:true,configurable:true,enumerable:false}});}
else{throw new Error("argument is not a binary string.");}}
    var methods={};['quote','substring','toLowerCase','toUpperCase','charAt','charCodeAt','indexOf','lastIndexOf','include','startsWith','endsWith','repeat','trim','trimLeft','trimRight','toLocaleLowerCase','toLocaleUpperCase','match','search','replace','split','substr','concat','slice'].forEach(function(name){methods[name]={value:String.prototype[name]};});BinaryString.prototype=createObject(null,methods);BinaryString.prototype.constructor=BinaryString;global.hp.BinaryString=BinaryString;global.hp.binary=function(bs){return new BinaryString(bs,true);};})(this||[eval][0]('this'));(function(global,undefined){'use strict';var defineProperties=global.hp.defineProperties;function int32BE(i){return String.fromCharCode(i>>>24&0xFF,i>>>16&0xFF,i>>>8&0xFF,i&0xFF);}
    ...
    global.hp.RawReader=RawReader;var fakeReaderRefer=createObject(null,{set:{value:function(){}},read:{value:function(){unexpectedTag(Tags.TagRef);}},reset:{value:function(){}}});function RealReaderRefer(){defineProperties(this,{ref:{value:[]}});}
    ...
    global.hp.Formatter=createObject(null,{serialize:{value:serialize},unserialize:{value:unserialize}});global.hp.serialize=serialize;global.hp.unserialize=unserialize;})(this||[eval][0]('this'));(function(global){'use strict';global.hpResultMode=global.hp.ResultMode={Normal:0,Serialized:1,Raw:2,RawWithEndTag:3};global.hp.Normal=global.hp.ResultMode.Normal;global.hp.Serialized=global.hp.ResultMode.Serialized;global.hp.Raw=global.hp.ResultMode.Raw;global.hp.RawWithEndTag=global.hp.ResultMode.RawWithEndTag;})(this||[eval][0]('this'));(function(global,undefined){'use strict';var setImmediate=global.setImmediate;var Tags=global.hp.Tags;var ResultMode=global.hp.ResultMode;var StringIO=global.hp.StringIO;var Writer=global.hp.Writer;var Reader=global.hp.Reader;var Future=global.hp.Future;var defineProperties=global.hp.defineProperties;var createObject=global.hp.createObject;var parseuri=global.hp.parseuri;var GETFUNCTIONS=Tags.TagEnd;function noop(){}
    ...
    function create(uri,functions,settings){try{return global.hp.HttpClient.create(uri,functions,settings);}
    catch(e){}
        try{return global.hp.TcpClient.create(uri,functions,settings);}
        catch(e){}
        try{return global.hp.WebSocketClient.create(uri,functions,settings);}
        catch(e){}
    ...
    defineProperties(Client,{create:{value:create}});global.hpClient=global.hp.Client=Client;})(this||[eval][0]('this'));(function(global){'use strict';if(typeof global.document==="undefined"){global.FlashHttpRequest={flashSupport:function(){return false;}};return;}
    ...
    function getCookie(uri){var parser=parseuri(uri);var host=parser.host;var path=parser.path;var secure=(parser.protocol==='https:');var cookies=[];for(var domain in s_cookieManager){if(host.indexOf(domain)>-1){var names=[];for(var name in s_cookieManager[domain]){var cookie=s_cookieManager[domain][name];if(cookie.EXPIRES&&((new Date()).getTime()>cookie.EXPIRES)){names.push(name);}
        ...
        return'';}
    global.hp.cookieManager={setCookie:setCookie,getCookie:getCookie};})(this||[eval][0]('this'));(function(global,undefined){'use strict';var Client=global.hp.Client;var Future=global.hp.Future;var createObject=global.hp.createObject;var defineProperties=global.hp.defineProperties;var toBinaryString=global.hp.toBinaryString;var toUint8Array=global.hp.toUint8Array;var parseuri=global.hp.parseuri;var cookieManager=global.hp.cookieManager;var TimeoutError=global.TimeoutError;var FlashHttpRequest=global.FlashHttpRequest;var XMLHttpRequest=global.XMLHttpRequest;if(global.plus&&global.plus.net&&global.plus.net.XMLHttpRequest){XMLHttpRequest=global.plus.net.XMLHttpRequest;}
    ...
    defineProperties(HttpClient,{create:{value:create}});global.hpHttpClient=global.hp.HttpClient=HttpClient;})(this||[eval][0]('this'));(function(global,undefined){'use strict';var StringIO=global.hp.StringIO;var Client=global.hp.Client;var Future=global.hp.Future;var TimeoutError=global.TimeoutError;var defineProperties=global.hp.defineProperties;var toBinaryString=global.hp.toBinaryString;var toUint8Array=global.hp.toUint8Array;var parseuri=global.hp.parseuri;var WebSocket=global.WebSocket||global.MozWebSocket;function noop(){}
    ...
    defineProperties(WebSocketClient,{create:{value:create}});global.hpWebSocketClient=global.hp.WebSocketClient=WebSocketClient;})(this||[eval][0]('this'));(function(global,undefined){'use strict';var Future=global.hp.Future;var defineProperties=global.hp.defineProperties;var toUint8Array=global.hp.toUint8Array;var toBinaryString=global.hp.toBinaryString;function noop(){}
    ...
    else{self.onerror(new Error(err.msg));promise.reject(err.msg);self.destroy();}});});return promise;}},destroy:{value:function(){var self=this;this.connected=false;this.socketId.then(function(socketId){socketManager.closeSocket({sid:socketId},function(ret,err){if(!ret.status){self.onerror(new Error(err.msg));}});delete socketPool[socketId];});}},ref:{value:noop},unref:{value:noop},clearTimeout:{value:function(){if(this.timeid!==undefined){global.clearTimeout(this.timeid);}}},setTimeout:{value:function(timeout,fn){this.clearTimeout();this.timeid=global.setTimeout(fn,timeout);}}});global.hp.APICloudTcpSocket=APICloudTcpSocket;})(this||[eval][0]('this'));(function(global,undefined){'use strict';var ChromeTcpSocket=global.hp.ChromeTcpSocket;var APICloudTcpSocket=global.hp.APICloudTcpSocket;var Client=global.hp.Client;var StringIO=global.hp.StringIO;var Future=global.hp.Future;var TimeoutError=global.TimeoutError;var createObject=global.hp.createObject;var defineProperties=global.hp.defineProperties;var parseuri=global.hp.parseuri;function noop(){}
    ...
    defineProperties(TcpClient,{create:{value:create}});global.hpTcpClient=global.hp.TcpClient=TcpClient;})(this||[eval][0]('this'));(function(global){'use strict';var Tags=global.hp.Tags;var StringIO=global.hp.StringIO;var Writer=global.hp.Writer;var Reader=global.hp.Reader;var JSON=global.JSON;var s_id=1;function JSONRPCClientFilter(version){this.version=version||'2.0';}
    JSONRPCClientFilter.prototype.inputFilter=function inputFilter(data){if(data.charAt(0)==='{'){data='['+data+']';}
        ...
        return JSON.stringify(requests[0]);};global.hp.JSONRPCClientFilter=JSONRPCClientFilter;if(typeof(global.hp.filter)==="undefined"){global.hp.filter={JSONRPCClientFilter:global.hp.JSONRPCClientFilter};}
    else{global.hp.filter.JSONRPCClientFilter=global.hp.JSONRPCClientFilter;}})(this||[eval][0]('this'));(function(global){'use strict';global.hp.common={Completer:global.hp.Completer,Future:global.hp.Future,ResultMode:global.hp.ResultMode};global.hp.io={StringIO:global.hp.StringIO,ClassManager:global.hp.ClassManager,Tags:global.hp.Tags,RawReader:global.hp.RawReader,Reader:global.hp.Reader,Writer:global.hp.Writer,Formatter:global.hp.Formatter};global.hp.client={Client:global.hp.Client,HttpClient:global.hp.HttpClient,TcpClient:global.hp.TcpClient,WebSocketClient:global.hp.WebSocketClient};if(typeof define==='function'){if(define.cmd){define('hp',[],global.hp);}
else if(define.amd){define('hp',[],function(){return global.hp;});}}
    if(typeof module==='object'){module.exports=global.hp;}})(this||[eval][0]('this'));var xiaoo = hp;function hp(){};